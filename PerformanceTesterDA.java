...
public class PerformanceTesterDA {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException{
        ...
        for (int n : sampleSizes) {
            ...
            for (int i = 0; i < k; i++) {
                ...
                //set 1////////////////////////////////////////////
                DynamicArraySet arrSet1 = new DynamicArraySet();
                long start1 = System.nanoTime();
                for (Record r : sample1) {
                    arrSet1.add(r.getValue());
                }
                ...
                //set 2////////////////////////////////////////////
                DynamicArraySet arrSet2 = new DynamicArraySet();
                long start2 = System.nanoTime();
                for (Record r : sample2) {
                    arrSet2.add(r.getValue());
                }
        ...
        exportTimings(insertionTimingsMap, "dynamicArraySet/insertion_timingsDA.csv");
        exportTimings(comparisonTimingsMap, "dynamicArraySet/comparison_timingsDA.csv");
    }
}